...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  AccessDenied:
    "That sign-in attempt was rejected. If you were signed in a moment ago this may just be a stale link — try signing in again.",
};
...
export function SignInForm({
  ...
  const message = error
    ? (ERROR_MESSAGES[error] ?? ERROR_MESSAGES.AccessDenied)
    : null;
